...
use walt_core::replay::{state_before_trick, voids_before_trick, ReplayError, TRICKS_PER_HAND};
use walt_core::{Domino, DominoSet, Seat};

use crate::kernel::{Hidden, Kernel, World, HIDDEN_SEATS};
...
impl ReceiptDecision {
    ...
    pub fn at(
        ...
        let mut hidden = [Hidden {
            seat: viewer,
            capacity: 0,
            voids: walt_core::ContextSet::EMPTY,
        }; HIDDEN_SEATS];
