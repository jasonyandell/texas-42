...
pub use equivariant::{
    ...
    closure_carrier, cut_suffix, grade, identity_key, node_constraint, open_variant, r1_refines_r3,
    suffix_library, trick_six_kernels, yard_shape, yard_tree, CandidateSpec, Canonical, Carrier,
    Census, ClassDag, Constraint, EclFailure, EclVerdict, Identities, Law, MoveTuple, PlayClass,
    RefinementViolation, Situation, SuffixLibrary, Token, YardNode, R3, SHAPE_PERM_CAP,
    YARD_TERMINAL,
};
pub use lumpability::{
