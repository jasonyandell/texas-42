...
use walt::rules::{Decl, Domino, Pip, Seat};
use walt::solver::{bp, mask_bits, mix, Deadline, Field, Key, Shared, Solver, SplitMix64};
...
fn sample_auction_belief(viewer_hand: u32, n: usize, rng: &mut SplitMix64) -> Vec<[u32; 4]> {
    ...
    let unseen = walt::solver::FULL_MASK & !viewer_hand;
