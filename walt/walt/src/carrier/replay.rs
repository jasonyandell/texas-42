use crate::rules::receipt;
use crate::rules::replay::{replay_hand, state_before_trick, voids_before_trick};
use crate::rules::{
...
impl CarrierFacts {
    ...
    pub const fn future_field_moves(&self) -> u32 {
        ((crate::rules::replay::TRICKS_PER_HAND + 1 - CARRIER_TRICK) * 3) as u32
    }
}
