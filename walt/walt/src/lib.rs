...
//!
//! One crate, originally seven modules, formerly seven crates (the fold is recorded
...
//! - [`scheme`] — typed relational expressions over kernel worlds
...
//!
//! The expressive [`scheme`] layer was added 2026-09-06 above rules/kernel;
//! it has no solver dependency and makes no compression claim.
//!
