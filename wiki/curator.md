...
**Book baseline: `ee44cb56` (2026-09-21, update Plunge URLs), curated
...
| 2 | `afd46420..ee44cb56` (1 landing, 2026-09-21), curated 2026-09-25 | PR #96, pending | stale URL fix: [walt-kiln](walt-kiln.md) §3 (Plunge domain rename: `plunge.jasonyandell.workers.dev` → `plunge.texas42.workers.dev`). Sorting: area. No foundation change |
