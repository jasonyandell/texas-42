...
[Home](Home.md) · owns: the register of walt's determinism freezes 1–55 —
...
`walt/walt-factory/examples/*.rs`, the results-file headers, and for freeze 55
the canonical descriptor in `walt-gpu-ref/src/receipt.rs`. Related:
...
All 55 issued numbers are accounted for: 53 spent, and **39 and 40 still
