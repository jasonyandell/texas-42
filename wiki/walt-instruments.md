...
Five bins built during the §22 / §21 build, each with a records directory
...
table are *asserted*, not printed). Per the receipt-discipline statements
