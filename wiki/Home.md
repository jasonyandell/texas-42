...
- [walt-gpu-native-trick1](walt-gpu-native-trick1.md) — the adjudicated narrow opening-root contract, portable M0/M1 status, Metal Gate 0, and the untouched proof-controller ladder.
