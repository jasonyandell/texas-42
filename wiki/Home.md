...
2026-09-20 (`afd46420`) for the walt layer, curated 2026-09-20 by cycle 1 of the
[curator](curator.md); the claim-tier chapters, the era records and everything
not dated later still describe `c00717d1` (2026-09-07); this page rewritten
2026-09-13.
...
- **Engineer who wants to run the player.**
  ...
  [`CLAUDE.md`](../CLAUDE.md) before starting anything long. For the seat as it
  is actually deployed — one crate on the phone and the Mac since 2026-09-14 —
  [walt-seat-play §8A](walt-seat-play.md#8a-the-shared-deployed-player-walt-player-2026-09-14-onward); for the native CPU speedups v34 and the 2026-09-20 phone release,
  [walt-instruments §3.7](walt-instruments.md#37-native-cpu-speedups-v34-and-the-phone-release-2026-09-18--09-20); for the opening bidding book Plunge bids from since 2026-09-19,
  [walt-kiln](walt-kiln.md) (added 2026-09-20).
...
| [`walt/`](walt.md) | **The project's player** — the imperfect-information seat. **Everything under it is EXPLORATORY, below every tier on this page**; [walt](walt.md) states the fence once. Objective ruled 2026-08-17: **P(make the bid)** — pmake; trick differential is a proxy. **The shape as of `afd46420` (2026-09-20; curated 2026-09-20, cycle 1 of the [curator](curator.md)):** the deployed Walt is **one crate on two hosts** — `walt-player` (2026-09-14), its WASM in Plunge on the phone and its native `walt-table` behind the Mac bridge, one decision procedure: level 1, voidless, fixed selection at 40/8 with an 8/2 reserve and an optional 500 ms partner check in 14 s, and a once-around auction at threshold 3/4 that its own record calls "deliberately an uncalibrated bidding policy" ([walt-seat-play §8A](walt-seat-play.md#8a-the-shared-deployed-player-walt-player-2026-09-14-onward)). Since 2026-09-19 its **bidding for catalogue hands is a table lookup** in Kiln's empirical book — 305,440 games of the deployed player at bid 30 over 500 catalogue hands, the recommendation the highest 30–42 target reached in 4/5 of games — with **play unchanged** ("The playing WASM and manifest are unchanged"; [walt-kiln §3](walt-kiln.md#3-the-empirical-bidder-release-in-plunge-2026-09-19)); Kiln "removes bidding latency; it does not close the partnership gap." Since 2026-09-20 the native default runs the **v34 CPU speedups** (13.13× median on 12/12 exact-equal paired L2 Partner solves), deployed to the phone the same day under conformance receipts only — "Finite conformance, not a proof of equivalence or player strength" (`release.json`; corrected 2026-09-21: the quote first placed here was `walt/MAP.md`'s on the 2026-09-14 shared deployment); hosted opening 265 ms, "Mac Chrome timings, not Pixel measurements" ([walt-instruments §3.7](walt-instruments.md#37-native-cpu-speedups-v34-and-the-phone-release-2026-09-18--09-20)). Around L1 sit **Sunshine's two optional partner-aware presets** (2026-09-13 → 09-15) — `l1-partner-count-review` (250 ms) and `l1-partner-rollout` (500 ms; Plunge's "L1 + partner check") — neither a default: every ordinary-game panel tied, "no demonstrated strength gain" ([walt-partnership-program §11](walt-partnership-program.md#11-sunshine-2026-09-13--09-15-the-partner-aware-live-player)); the exact gym now names its continuation and the Mac table feeds flagged human-play moves into it ([walt-gym §11](walt-gym.md#11-sunshine-2026-09-13-the-gym-under-deployed-continuations-and-the-live-move-intake), [walt-scheme-fix §10.4](walt-scheme-fix.md#104-sunshine-2026-09-13--09-15-the-count-offer-query-as-a-live-gate-and-recipes-with-a-selectable-continuation)). **What remains open:** the partnership gap — no tested partner model beat the phone or L1 ([walt-partnership-program §9](walt-partnership-program.md#9-what-is-settled-and-what-is-open); unquoted 2026-09-21: the chapter's sentence, not a source's) and, in Sunshine's words, "The partnership gap is still open" (`SUNSHINE-NOTES.md`); the Kiln calibration gap's cause (forecast 121/160 against 21/100 executed — "a candidate explanation, not a cause established by the experiment"); and the full walt gate, not recorded run on any landing since 2026-09-06 (`full_workspace_ci: "not run"` on the v34 receipts). **By era, each clause pointing at its chapter:** the frozen-basis research programs of 2026-08-09 → 08-16 — the opening situation space does not compress, the decision side does ([walt-pre-pivot-results](walt-pre-pivot-results.md); the four era pages are provenance) · the pivot to play, 2026-08-17: the level-1 scenario-player seat that defeated the mk5 E[Q] champion under the dropped-30 3×384 protocol — 630/1152 pooled, McNemar z = +6.28, an arena outcome about play, never a statement about exact values (record `walt/probes/m3/arena_results_2026-08-17.txt`) — and has run live in plunge ([walt-seat-play](walt-seat-play.md)) · calculated evidence, 2026-08-24 → 08-29: anytime-valid adaptive settlement (CE-A1..A8, L2-A1..A7), the §22 build, the field swaps, the controller and waking seats ([walt-calculated-evidence](walt-calculated-evidence.md)) · counted belief and the anytime proof state, 2026-08-30 → 09-01 (CBS-A1..A9, APS-A1..A9, Phases 0–8): exact integer masses over the 399,072,960-world opening fiber and a certified-regret verdict at the receipt opening root — play 6-5, floor 732‰, at most 267‰ unclaimed, an honest UNRESOLVED at ε = 1/4 (record `walt/probes/factor_belief/openingreport_run1.txt`); the doom census's first reading of that 267‰ as "overwhelmingly the info-consistency price" was corrected 2026-09-03 — **the split is UNKNOWN** ([`walt/DISCREPANCIES.md`](../walt/DISCREPANCIES.md)) ([walt-counted-belief-era](walt-counted-belief-era.md)) · the focal horizon, 2026-09-01 → 09-05, under Jason's frame "**two recursions running in opposite directions**": model belief (MB0/MB1), the σ1 repair, the God-gap censuses (U0/U0b), the unified player (UP0/UP1a), the focal-horizon hierarchy FH0–FH5, audited and merged 2026-09-07 (PR #88); its finding: every live trick-4 coordinate settles by k ≤ 2 and the residual width is the tail's policy gap, not fusion price (record `walt/probes/factor_belief/focal_run1.txt`) ([walt-focal-horizon-era](walt-focal-horizon-era.md)) · the Gran anchors: the real "6-4" hands reconstructed, validated and played by three walts; exact indifference and the tie-break; obligation O5; two unmerged branches ([walt-gran-anchors](walt-gran-anchors.md)) · the partnership program, Scheme/Fix and the exact gym, 2026-09-06/07, landed CI-waived: no partner model has beaten its reference ([walt-partnership-program](walt-partnership-program.md), [walt-scheme-fix](walt-scheme-fix.md), [walt-gym](walt-gym.md)). The GPU side track holds portable M0/M1 and M2 Metal parity under freezes 55/56 and no player ([walt-gpu-native-trick1](walt-gpu-native-trick1.md)). The crate: **one crate `walt` of ten modules across six workspace members** (corrected 2026-09-20: eleven modules — `clock` added 2026-09-14 — across **eight** members, `walt-player` and `walt-cpu-bench` added; 58 binaries; [walt-architecture](walt-architecture.md) §1; the instruments on [walt-instruments](walt-instruments.md)). **No default change since 2026-08-19** (θ = 11/16; CE-A7/§20.16, restated by CBS-A9, APS-A9, MB-A7, FH-A10); code changes on the live path are parity-gated ([walt-seat-play](walt-seat-play.md) §8). (Corrected 2026-09-20: true through `c00717d1`. On 2026-09-14 the seat Plunge ships became the shared `walt-player` procedure — fixed selection in place of the phone's race-on refine, an 8/2 reserve, the optional partner check, the regular auction in place of Plunge's `mediumBid` ladder — under conformance receipts, with no record citing CE-A7 or an arena gate for the change; the level, the inner belief, the objective and the rules profile did not change. Since 2026-09-19 catalogue-hand bidding is the Kiln lookup; play unchanged. Since 2026-09-20 the v34 CPU speedups are the native default and the phone's build — §8A.) Jason's ruling of 2026-09-04: **no new mathematical parent until the consolidation slice lands** ([[consolidation-slice]]). Refutations at [walt-negative-results](walt-negative-results.md); the resets at [walt-program](walt-program.md). |
| [`experiments/`](../experiments/partnership/) | `experiments/partnership/` — the 2026-09-06/07 partnership program: a Codex session under an explicit CI waiver (`walt/ci/check.sh` was not run on `d8400713..c00717d1`), the archived Plunge WASM as the frozen "phone" reference, the native player families (L1 default, L2 Partner, L2 Partner with voids), matched full-game batteries, the pool infrastructure, policy synthesis and relational learning. **EXPLORATORY, CI-waived**; the negative strength results are stated as such on the owning chapter, [walt-partnership-program](walt-partnership-program.md). Status ledger `experiments/partnership/SESSION-STATUS.md`. (Added 2026-09-20: since 2026-09-13 the directory also holds Sunshine — `SUNSHINE-NOTES.md`, the partner review and rollout, the Mac table, six further campaigns — [walt-partnership-program §11](walt-partnership-program.md#11-sunshine-2026-09-13--09-15-the-partner-aware-live-player); and since 2026-09-18 **`experiments/kiln/`** holds the opening bidding book and the four mining studies on its played corpus ([walt-kiln](walt-kiln.md)). The CI waiver continues through every landing 2026-09-13 → 09-20.) |
...
- [timeline](timeline.md) — the dated record: every landing from the v0.7 ingest (2026-07-26) to `afd46420` (2026-09-20; Part E, added 2026-09-20, is cycle 1's intake `c00717d1..afd46420`), by wave, with commit hash and/or PR number, what each established at which tier, and the page that owns it.
...
- [walt-seat-play](walt-seat-play.md) — how walt plays: the one decision procedure and its three axes, every configuration that coexists, the 2026-08-17 match, the level-2 question, bidding and declaring, the variant seats, surfaces and gates, the live-code changes since 2026-08-25 with no default change, debts; and, since 2026-09-14, the shared deployed player `walt-player` on both hosts (§8A, added 2026-09-20).
...
- [walt-partnership-program](walt-partnership-program.md) — `experiments/partnership/` 2026-09-06/07: the launch packet, the "phone" reference, the player families, every battery and its numbers, the pool infrastructure, policy synthesis and relational learning, what is settled and open; Sunshine, 2026-09-13 → 09-15 — the partner review, the partner rollout, the recipes and playable campaigns, the harness goals (§11, added 2026-09-20).
- [walt-gym](walt-gym.md) — the exact partnership gym: what a coordinate is, how an answer key is defined and audited, Scheme-driven discovery, the 6 → 170 → 433 → 30 results ladder, reproduction; the gym under deployed continuations, the targeted replay of its misses, and the live-move intake from the Mac table (§11, added 2026-09-20).
- [walt-scheme-fix](walt-scheme-fix.md) — the Scheme/Fix relational expression language as implemented (`walt::scheme`, 2026-09-06/07: grammar, semantics, beliefs and counterexamples, finite dynamics, executable policies) and the archived descriptor research that preceded it; the count-offer query as a live gate and recipes with a selectable continuation (§10.4, added 2026-09-20).
- [walt-kiln](walt-kiln.md) — Kiln, the opening bidding book for Plunge (2026-09-18 → 09-19; EXPLORATORY; an area; added 2026-09-20): the frozen scalar-price survey (1,001,348 receipts / 851 settled deals) and its sixes/36 calibration gap (121/160 forecast against 21/100 executed), the actual-play campaign (500 hands, 4,500 panels, 305,440 games, the 4/5 score-tail rule, 75 capped-unsettled), the empirical bidder live in Plunge since 2026-09-19 (`c7a1215d`; play unchanged), the sample-history instrument, Sunshine Atlas and Pattern Workshop, the four mining studies on the played corpus (§8), and the solver work measured through the Kiln bench (§9).
...
- [walt-architecture](walt-architecture.md) — the `walt` crate: the six-crate workspace and the one crate's ten modules (eight crates and eleven modules since 2026-09-20 — §1.1, §1.3, §1.4, §3.9, corrected in place), the two solver stacks and their seams, invariants carried by types and CI, the gate and what it costs, the declared epochs, named debts and freezes by path.
- [walt-instruments](walt-instruments.md) — the instrument catalog: every binary under `walt/walt/src/bin/` with its purpose, invocation, record path, gate, cost and status, by program; the seats a person can play (with `walt-table` and the `walt-player` WASM since 2026-09-14, §1); how to read a record; the archive-only historical inventory; the native CPU speedups v34 and the 2026-09-20 phone release (§3.7).
