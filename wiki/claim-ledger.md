...
Seven results from the Claude ↔ ChatGPT 5.6 Pro exchange
...
`exchange/adjudication/programs/`. Dispatch 008 is submitted and pending — nothing
from it enters this table until adjudicated.
