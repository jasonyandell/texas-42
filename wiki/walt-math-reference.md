...
> [received artifacts and intakes](walt-math-intakes.md). *(Extended
> 2026-08-24, later the same day:)* the adaptive-sampling mathematics
> **landed** as the two calculated-evidence-lineage drops and both are
> indexed below — the CE-A and L2-A ruling families, the two received
> parents in the governing-documents table, and the era narrative on
...
| **CE step-7 shadow** | the controller beside the live player (2026-08-24): 33 hands / 183 decisions at δ_run = 1/100, world_cap 128 — instrument records, model-relative winners, no live change | `walt/probes/shadow/` (README + JSONL + `summarize.py`) |
