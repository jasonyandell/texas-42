...
| ID | Claim | Exact statement | Assumptions | Status | Source |
|---|---|---|---|---|---|
| ALG-01 | Double-six cardinality | \(|\mathcal D|=28\). | Two-element multisets over seven pips. | THEOREM — proved | Math §2.1 |
...
| ALG-20 | Looped-graph universe | \(\mathcal D=\operatorname{Sym}^2(\mathbb P)\) is exactly the edge set of complete looped \(K_7\); natural suits are closed stars. | Canonical unordered endpoint identity. | DEFINITION / COROLLARY — proved | Math §§2.1–2.2 |
| ALG-21 | Count antidiagonal | \(c(d)=\operatorname{sum}(d)\) exactly on sums 5 and 10 and is zero otherwise. | Double-six universe and Straight count rule. | THEOREM — proved | Math §2.4 |
| ALG-22 | All pip-trump unscored transports | The order-preserving complement map gives \(\mathcal M_t\cong\mathcal M_u\) for every ordered pair of pip trumps. | Count decoration and literal numeric rank labels omitted; contexts transported. | THEOREM — proved | Math §3.10 |
| ALG-23 | Three unscored mechanics classes | The nine declarations have exactly three unscored mechanics classes: pip trump, doubles-trump, and no-trump. | Structure named in Math §3.10. | THEOREM — proved | Math §3.10 |
| ALG-24 | Unscored transport receipt | All 49 ordered pip-trump transports preserve the full named unscored relation surface; 307,328 contextual order comparisons are checked and the three class signatures are confirmed. | Exact finite declaration/domino/context domain. | THEOREM — finite verification | Math §3.10; reduced-kernel verifier |
...
| PLAY-12 | Current-trick fold congruence | Led context, current competitive-strength ordinal, current winner, and pending count determine every future legality, winner update, and trick reward for common continuations. | Declaration, remaining hands or exact support, and actor order supplied. | THEOREM — proved | Math §7.16.1 |
| PLAY-13 | Folded-trick finite bounds | Competitive chain length is at most 13; unresolved pending count is one of 0,5,10,15,20,25, giving a transparent 12-bit field bound. | Straight declarations and unresolved trick of length 1–3. | THEOREM — proved / THEOREM — finite verification / BOUNDARY | Math §7.16.1; reduced-kernel verifier |
| PLAY-14 | Actor from capacities | In an open trick, remaining-hand sizes uniquely determine leader, plays made, and next actor; at a boundary the leader remains explicit. | Legal Straight hand-size pattern. | THEOREM — proved / THEOREM — finite verification | Math §7.16.2; reduced-kernel verifier |
| PLAY-15 | Total banked-score recovery | Total banked points are recovered from completed-trick count, count remaining in all hands, and pending trick count; storing both partnership totals is redundant. | Exact remaining pool and open-trick residue. | THEOREM — proved / FINITE VERIFICATION RECEIPT | Math §7.16.3; reduced-kernel verifier |
| PLAY-16 | Utility-specific score residue | Additive continuation returns may use transition rewards with any banked root offset external; contract and match utilities retain their named sufficient accumulator. No universal utility-independent minimum is claimed. | Fixed utility interface and reward accounting boundary. | COROLLARY / SYNTHESIS | Math §7.16.3 |
| PLAY-17 | Reduced viewer kernel sufficiency | \(K=(\delta,H_m,N,\tau,\alpha_U)\) determines exact within-hand viewer legality, hidden-action acceptance/support update, actor order, trick evolution, terminal detection, and the named utility transition. | Fixed contract, viewer frame, and utility interface. | THEOREM — proved | Math §7.16.4 |
...
| CELL-09A | Capacitated matching kernel | A capacity-cell fiber is exactly the set of complete feasible left-perfect bipartite \(b\)-matchings with holder demands. | Finite pool and labeled holder capacities. | DEFINITION / COROLLARY / SYNTHESIS | Math §7.7.1 |
...
| CELL-10H | Exact capacity dynamic program | Occupancy-vector DP computes unrestricted fiber count exactly; under structural conservation, each bounded occupancy vector lies in one unique layer, giving at most \(\prod_s(k_s+1)\) states total, \(|J|(\prod_s(k_s+1)-1)\) candidate-holder checks, and \(\sum_s k_s\prod_{r\ne s}(k_r+1)\) capacity-eligible updates. | Finite cell system; resource bounds require \(|U|=\sum_sk_s\). | THEOREM — proved | Math §7.8 |
| CELL-10I | Native count bound | A native unrestricted fiber has at most 399,072,960 worlds; one exact count visits at most 512 occupancy states total, performs at most 1,533 candidate-holder checks and 1,344 capacity-eligible updates, and has at most 48 live states in one layer. | Three hidden seats, \(|U|=\sum_sk_s\le21\), \(k_s\le7\). | THEOREM — proved | Math §7.8 |
...
| CELL-26 | Fiber-local optimal rank | A world in a supplied fiber has an exact fixed-width rank of \(\lceil\log_2|\Phi|\rceil\) bits, at most 29 natively. | Fixed support and ordering. | THEOREM — proved / BOUNDARY | Math §7.12.4 |
...
| REACH-03A | Standalone support boundary | Reachable support identifies an exact fiber but is not a complete game state; with declaration and the full typed public observation context supplied, exact support transition does factor through it. | Standalone support identifier versus typed support-transition problem. | BOUNDARY | Math §§7.13, 7.14.1 |
...
| REACH-11 | Reachable-support ceiling | 64,123,542,674,901 declaration-tagged necessary outer certificates cover every reachable support; hence standalone reachable support needs at most 46 bits. | Exact capacity/schedule/lead-witness outer language. | THEOREM — finite verification / BOUNDARY | Math §7.13.6; verification output |
| REACH-11A | Context-relative ceilings | Outer-certificate ceilings are 43 bits with declaration supplied, 43 with capacity profile supplied, and 40 with both supplied. | Same outer language; not exact minima. | THEOREM — finite verification / BOUNDARY | Math §7.13.6; verification output |
...
| REACH-14 | Symbolic trace equivalence | The symbolic support machine accepts an actor-attributed public play trace iff at least one complete deal legally realizes it; its final support is exact. | Viewer hand, contract, declaration, leader, and exact typed support transition supplied. | THEOREM — proved | Math §7.13.7 |
| REACH-15 | Deal-free reachability certificate | Viewer hand plus public contract/declaration, leader, actor-attributed trace, and claimed final support is an exact certificate; no hidden deal is required. | Symbolic trace theorem. | COROLLARY — proved | Math §7.13.7 |
| REACH-16 | Reachable symbolic support DAG | The symbolic play/support graph is finite and remaining-tile graded, and its support-output image is exactly the reachable support image. | Contracted Straight hand. | COROLLARY — proved | Math §7.13.7 |
...
| TRANS-08 | Support-normal dynamic sufficiency | Exact predecessor support plus declaration and typed public action context uniquely determines exact successor support. | Feasible exact support normal form; hidden observation typed as lead/follow/slough. | THEOREM — proved | Math §7.14.1 |
| TRANS-09 | Matching-minor update | Force possession, delete slough-forbidden edges, contract the played tile, and reduce to the matching-supported core equals extensional conditioning and typed pushforward. | TRANS-08 scope. | THEOREM — proved | Math §7.14.1 |
| TRANS-10 | Holder-edge monotonicity | Every surviving hidden tile's exact marginal holder set can only shrink during one deal attempt. | Accepted public play; exact support. | THEOREM — proved | Math §7.14.2 |
| TRANS-11 | Ambiguity-phase monotonicity | Certainty never becomes ambiguity, inactive ambiguity seats do not reactivate, and tags move only ternary→binary→determinate. | TRANS-10 and canonical normal form. | COROLLARY — proved | Math §7.14.2 |
| TRANS-12 | Sixty-three-edge hand budget | Initial exact support has 63 holder edges; all disappear exactly once, with at most 42 deletions while their tiles remain live. | Straight viewer support at the first play. | THEOREM — proved | Math §7.14.2 |
| TRANS-13 | Reduced support-dynamics exhaustion | On 1,331 feasible exact supports of size at most four, 170,058 typed observations agree between extensional conditioning and direct matching-minor update; 1,406,592 survivor-edge tests confirm monotonicity. | Complete canonical tiny support domain stated by verifier. | THEOREM — finite verification | Math §7.14.2; reduced-kernel verifier |
| TRANS-14 | Whole-hand edge-budget receipt | Across 108 deterministic complete hands and 3,024 public transitions, exact support performs 6,804 edge deletions, exactly 63 per hand, with no reappearance. | Named all-declaration corpus. | FINITE VERIFICATION RECEIPT | Math §7.14.2; reduced-kernel verifier |
...
| SYM-04 | Oriented dihedral gauge | Rotations and reflections form an exact \(D_4\) coordinate gauge only when reflection also transports orientation and every orientation-dependent object. | Oriented-frame family; policies, evidence, teams, actions, and utility transported. | THEOREM — proved / BOUNDARY / THEOREM — finite verification | Math §12.7.1; reduced-kernel verifier |
...
| QUO-09 | Mechanical future equivalence | Two states are equivalent for a named finite output contract iff every finite action word produces the same legality/output response. | Finite reachable partial deterministic machine and finite action alphabet. | DEFINITION | Math §12.10 |
| QUO-10 | Output-relative global transition minimum | The future-equivalence quotient is, up to isomorphism, the unique smallest deterministic exact reachable machine realizing the selected output contract; every exact realization factors onto it. | QUO-09 scope. | THEOREM — proved | Math §12.10 |
| QUO-11 | Future-equivalence finite receipt | Partition refinement agrees with independent future-trace equivalence on all 5,898 total two-action binary-output machines with at most three states and 17,560 state pairs. | Exact finite machine domain. | THEOREM — finite verification | Math §12.10; reduced-kernel verifier |
| FAC-01 | Exact current decision factorization | Declaration algebra, ambient marked hand, exact physical/support kernel, retained continuation record, augmented belief, typed transition, field, and utility compose the exact current decision object within their named scopes. | Straight cell/reachability scope; fixed continuation problem; §10.1 assumptions. | COROLLARY / SYNTHESIS | Math §15 |
| FAC-02 | Reduced exact factorization | Minimal exact hidden support, folded play residue, and a named utility accumulator form an exact reduced physical/support kernel; history remains separately in evidence when it matters. | Fixed contracted-hand problem and selected utility interface. | THEOREM — proved / COROLLARY / SYNTHESIS | Math §§7.16, 15 |

## 10. Unresolved mathematical boundaries

| ID | Statement | Status |
|---|---|---|
| OPEN-01 | The reduced viewer kernel is exact, and the global transition minimum is defined by future equivalence for each output contract; equality of the explicit kernel with any selected quotient is not established. | UNRESOLVED |
...
| OPEN-12 | No closed-form local support-only reachability criterion is known; symbolic public-trace replay is exact and removes the need to supply a hidden deal, but it still carries legal ancestry. | UNRESOLVED / BOUNDARY |
