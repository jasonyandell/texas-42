...
mathematical foundation.  It is dependency-free and intentionally does not
serve as implementation source code.
"""
...
def check_reachable_support_bounds() -> dict[str, int]:
    ...
    profiles = hidden_capacity_profiles()
    by_profile = {
        capacities: outer_certificate_count(capacities, witness_counts)
...
def main() -> None:
    ...
    print(
        "outer reachability certificates: "
