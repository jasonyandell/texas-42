# partner-race-fixedmind versus l1-race

EXPLORATORY. Bid 30, identical deals and contracts, player teams swapped.

Completed 1/25 mirrored deals; 1 in complete analysis groups (1 independent deal units).

A pair wins/losses/ties: **0/0/1**. Contract wins: **1 A / 1 B**.
...
|---|---:|---:|
| l1-race | 0.441 | 0 / 17 |
| partner-race-fixedmind | 2.200 | 2 / 20 |

Stopped: fallback-rate-exceeds-five-percent:partner-race-fixedmind
